...
<center>
<img width='1000' src='images/militarypay.png' />
</center>
...
1. select(): keeps *variables* of interest (and rename() ), i.e., columns
2. filter():  subsets *cases* of interest, i.e., rows
...
# ggplot2 (the package) &  ggplot (the function)
